...
```bash
cd /Users/user/Genealogy && npm install reactflow react-leaflet leaflet @types/leaflet
```
...
```bash
cd /Users/user/Genealogy && git add src/components/layout/AppShell.tsx src/app/(app)/tree/page.tsx src/app/(app)/layout.tsx && git commit -m "feat(views): wire activeView state into AppShell + Topbar"
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/__tests__/ViewRouter.test.tsx 2>&1 | tail -10
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/__tests__/ViewRouter.test.tsx
```
...
```bash
cd /Users/user/Genealogy && npx vitest run 2>&1 | tail -5
```
...
```bash
cd /Users/user/Genealogy && git add src/components/views/ && git commit -m "feat(views): ViewRouter + stub views"
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/sablier/__tests__/sablierLayout.test.ts 2>&1 | tail -10
```
...
```bash
cd /Users/user/Genealogy && git add src/components/views/sablier/__tests__/sablierLayout.test.ts && git commit -m "test(sablier): failing tests for sablierLayout"
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/sablier/__tests__/sablierLayout.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/components/views/sablier/sablierLayout.ts && git commit -m "feat(sablier): BFS layout algorithm for hourglass tree"
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/sablier/__tests__/SablierView.test.tsx 2>&1 | tail -15
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/sablier/__tests__/SablierView.test.tsx
```
...
```bash
cd /Users/user/Genealogy && git add src/components/views/sablier/SablierView.tsx && git commit -m "feat(sablier): React Flow hourglass tree view"
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/timeline/__tests__/TimelineView.test.tsx 2>&1 | tail -10
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/timeline/__tests__/TimelineView.test.tsx
```
...
```bash
cd /Users/user/Genealogy && git add src/components/views/timeline/ && git commit -m "feat(timeline): SVG horizontal timeline by birth year"
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/carte/__tests__/CarteView.test.tsx 2>&1 | tail -15
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/carte/__tests__/CarteView.test.tsx
```
...
```bash
cd /Users/user/Genealogy && git add src/components/views/carte/ && git commit -m "feat(carte): Leaflet map view with birth/death markers"
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/eventail/__tests__/EventailView.test.tsx 2>&1 | tail -10
```
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/views/eventail/__tests__/EventailView.test.tsx
```
...
```bash
cd /Users/user/Genealogy && git add src/components/views/eventail/ && git commit -m "feat(eventail): SVG fan chart with ancestor rings"
```
...
```bash
cd /Users/user/Genealogy && git add -A && git commit -m "fix(views): resolve any build/type issues"
```
