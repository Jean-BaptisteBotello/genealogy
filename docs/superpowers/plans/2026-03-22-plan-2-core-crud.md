...
```bash
cd /Users/user/Genealogy && npx vitest run src/lib/geocode.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/lib/geocode.ts src/lib/geocode.test.ts
...
```bash
cd /Users/user/Genealogy && npx vitest run src/lib/cycle-detection.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/lib/cycle-detection.ts src/lib/cycle-detection.test.ts
...
```bash
cd /Users/user/Genealogy && git add src/lib/context/tree-context.tsx
...
```bash
cd /Users/user/Genealogy && npx vitest run src/server-actions/__tests__/persons.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/server-actions/persons.ts src/server-actions/__tests__/persons.test.ts
...
```bash
cd /Users/user/Genealogy && npx vitest run src/server-actions/__tests__/relationships.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/server-actions/relationships.ts src/server-actions/__tests__/relationships.test.ts
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/person/__tests__/PersonModal.test.tsx
```
...
```bash
cd /Users/user/Genealogy && git add src/components/person/PersonModal.tsx src/components/person/__tests__/PersonModal.test.tsx
...
```bash
cd /Users/user/Genealogy && git add src/components/layout/AppShell.tsx
...
```bash
cd /Users/user/Genealogy && git add \
  src/app/(app)/layout.tsx \
  src/app/(app)/tree/page.tsx \
  src/components/layout/Topbar.tsx \
  src/components/layout/Sidebar.tsx \
...
```bash
cd /Users/user/Genealogy && npx vitest run src/server-actions/__tests__/branches.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/server-actions/branches.ts src/server-actions/__tests__/branches.test.ts
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/branch/__tests__/BranchModal.test.tsx
```
...
```bash
cd /Users/user/Genealogy && git add src/components/branch/BranchModal.tsx src/components/branch/__tests__/BranchModal.test.tsx
...
```bash
cd /Users/user/Genealogy && npx vitest run src/server-actions/__tests__/documents.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/server-actions/documents.ts src/server-actions/__tests__/documents.test.ts
...
```bash
cd /Users/user/Genealogy && npx vitest run src/server-actions/__tests__/search.test.ts
```
...
```bash
cd /Users/user/Genealogy && git add src/server-actions/search.ts src/server-actions/__tests__/search.test.ts
...
```bash
cd /Users/user/Genealogy && npx vitest run src/components/search/__tests__/SearchOverlay.test.tsx
```
...
```bash
cd /Users/user/Genealogy && git add src/components/search/SearchOverlay.tsx src/components/search/__tests__/SearchOverlay.test.tsx
...
```bash
cd /Users/user/Genealogy && git add src/components/layout/Sidebar.tsx
...
```bash
cd /Users/user/Genealogy && git add src/components/layout/DetailPanel.tsx
