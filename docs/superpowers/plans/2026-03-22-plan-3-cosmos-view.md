...
```bash
cd /Users/jbbotello/Genealogy && npx vitest run src/components/cosmos/__tests__/cosmosLayout.test.ts
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/__tests__/cosmosLayout.test.ts && git commit -m "test(cosmos): failing tests for cosmosLayout BFS algorithm"
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/cosmosLayout.ts && git commit -m "feat(cosmos): BFS layout algorithm with orbital distance"
```
...
```bash
cd /Users/jbbotello/Genealogy && npx vitest run src/components/cosmos/__tests__/CosmosNode.test.tsx
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/__tests__/CosmosNode.test.tsx && git commit -m "test(cosmos): failing tests for CosmosNode SVG component"
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/CosmosNode.tsx && git commit -m "feat(cosmos): CosmosNode SVG circle with initials and hover"
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/CosmosEdge.tsx && git commit -m "feat(cosmos): CosmosEdge SVG bezier path by relationship type"
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/CosmosTooltip.tsx && git commit -m "feat(cosmos): CosmosTooltip foreignObject overlay"
```
...
```bash
cd /Users/jbbotello/Genealogy && npx vitest run src/components/cosmos/__tests__/CosmosView.test.tsx
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/__tests__/CosmosView.test.tsx && git commit -m "test(cosmos): failing tests for CosmosView canvas"
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/components/cosmos/CosmosView.tsx && git commit -m "feat(cosmos): CosmosView SVG orbital canvas"
```
...
```bash
cd /Users/jbbotello/Genealogy && git add src/app/(app)/tree/page.tsx && git commit -m "feat(cosmos): wire CosmosView into tree page"
```
...
```bash
cd /Users/jbbotello/Genealogy && npx next build
```
...
```bash
cd /Users/jbbotello/Genealogy && git log --oneline -10
```
