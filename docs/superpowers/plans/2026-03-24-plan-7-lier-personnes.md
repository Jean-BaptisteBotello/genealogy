...
const persons = [
  {
    id: CURRENT_ID, prenom: 'Jean-Baptiste', nom: 'Botello',
  ...
  {
    id: OTHER_ID, prenom: 'Pierre', nom: 'Botello',
...
1. `npm run dev`
2. Ajouter une deuxième personne (ex: Pierre Botello, 1960)
3. Cliquer sur Jean-Baptiste → DetailPanel → section Relations → cliquer `[+]`
4. Taper "Pierre" dans la recherche → sélectionner Pierre Botello
5. Cliquer "père" → cliquer "Lier →"
6. Vérifier : la relation "père → Pierre Botello" apparaît dans la liste avec le bon label
